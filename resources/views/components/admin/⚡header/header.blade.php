        ...
        <div class="w-full flex items-center gap-x-1.5">
            ...
            <ul class="flex items-center gap-1.5">
                <li class="inline-flex items-center gap-1 relative pe-1.5 last:pe-0 last:after:hidden after:absolute after:top-1/2 after:end-0 after:inline-block after:w-px after:h-3.5 after:bg-navbar-2-divider after:rounded-full after:-translate-y-1/2 after:rotate-12">
                    ...
                    <span class="hidden sm:block text-sm font-semibold text-foreground ms-1">
                ...
                <li x-data="{
                    ...
                    <button @click="open = !open"
                        ...
                        <span x-show="unreadCount > 0" x-cloak
                            class="absolute -top-0.5 -end-0.5 flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold text-white bg-red-500 rounded-full border-2 border-white">
                    ...
                    <div x-show="open"
                        ...
                        class="absolute right-0 top-full mt-2 w-96 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl z-50 overflow-hidden"
                        style="display: none;">
                        ...
                        <div class="max-h-80 overflow-y-auto divide-y divide-gray-100 dark:divide-gray-800">
                            ...
                            <template x-for="notification in notifications" :key="notification.id">
                                <div class="px-4 py-3 flex items-start gap-3 transition-colors"
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-gray-800 dark:text-gray-200 leading-snug break-words"
                            ...
                            <div x-show="notifications.length === 0" class="py-12 text-center">
                                ...
                                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">No notifications yet</p>
                            </div>
                        ...
                        <div x-show="notifications.length > 0"
                            class="px-4 py-3 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 text-center">
                            ...
                            <div class="py-3 px-3.5 border-b border-dropdown-divider">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-muted-foreground-1 capitalize">
