            ...
            <ul class="flex flex-row items-center gap-x-1 sm:gap-x-2 ms-auto shrink-0">
                ...
                <li x-data="{
                    ...
                    <button @click="open = !open"
                        ...
                        <svg class="shrink-0 size-4.5 sm:size-5 dark:text-yellow-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    {{-- Dropdown Panel — teleported to <body> so it escapes any
                         ...
                         which was previously collapsing this into a narrow sliver.
                         Fixed & centered on mobile, right-anchored on sm+. --}}
