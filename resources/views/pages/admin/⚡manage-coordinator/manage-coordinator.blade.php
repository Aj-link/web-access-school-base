    ...
    <div class="overflow-x-auto bg-white dark:bg-neutral-800 rounded-xl border border-gray-200 dark:border-neutral-700 shadow-sm">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            <thead class="bg-gray-50 dark:bg-neutral-900/30">
                <tr>
                    <th class="px-4 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Requester</th>
                    <th class="px-4 py-2.5 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Department</th>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700/30 transition">
                        ...
                        <td class="px-4 py-2.5">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <p class="text-xs font-medium text-gray-800 dark:text-neutral-200 leading-tight">{{ $req->user->name }}</p>
                                    <p class="text-[11px] text-gray-400 dark:text-neutral-500 leading-tight">{{ $req->user->email }}</p>
                                </div>
                            </div>
                        </td>
