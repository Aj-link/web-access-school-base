    ...
    <div class="max-w-4xl mx-auto px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <div class="bg-white dark:bg-neutral-800 border rounded-xl shadow overflow-hidden">
            ...
            <div class="px-6 py-4 border-b">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">Request Materials</h2>
                <p class="text-sm text-gray-600 dark:text-neutral-400">Fill out the form to request materials</p>
            </div>
